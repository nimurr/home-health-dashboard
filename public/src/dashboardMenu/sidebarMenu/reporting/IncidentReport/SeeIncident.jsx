...
import url from '../../../../redux/api/baseUrl';
import { useGetIncidentQuery } from '../../../../redux/features/reporting/getIncident';
...
const SeeIncident = () => {
  ...
  const {data: documents ,isLoading} = useGetIncidentQuery()
    ...
    return (
        <div className='mt-6'>
               ...
               <Link to ='/dashboard/reporting/incidentreport' className="flex items-center gap-2">
               <IoIosArrowBack className="  w-8 h-8"/>
        <p className="font-semibold text-[30px]">Incident-Report Document</p>
      </Link>
  ...
  > 
    ...
    <div className="flex justify-around mt-4">
      <Button   onClick={() => navigate(`editincident`, { state: { document } })} type="primary" className="bg-teal-500">Edit</Button>
