...
import { useUpdateIncidentMutation } from '../../../../redux/features/reporting/updateIncident';
...
const EditIncidentReport = () => {
  ...
  const [updateCgReport, { isLoading }] = useUpdateIncidentMutation();
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      // console.log(res);
      navigate('/dashboard/reporting/seeincident');
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="mt-8 container mx-auto px-8">
      ...
      <div className="flex justify-between mb-6">
        <Link to="/dashboard/reporting/seeincident" className="flex items-center gap-2">
