...
const SeeReport = () => {
  ...
  const {data: documents ,isLoading} = useGetReportQuery()
    ...
    return (
        <div className='mt-6'>
               ...
               <Link to ='/dashboard/reporting/cgreporting' className="flex items-center gap-2">
               <IoIosArrowBack className="  w-8 h-8"/>
        <p className="font-semibold text-[30px]"> CG-Report Document</p>
      </Link>
  ...
  > 
    ...
    <div className="flex justify-around mt-4">
      <Button   onClick={() => navigate(`editcgreport`, { state: { document } })} type="primary" className="bg-teal-500">Edit</Button>
