...
import { useUpdateInsuranceMutation } from '../../../../redux/features/reporting/updateInsurance';
...
const EditInsurance = () => {
  ...
  const [updateCgReport, { isLoading }] = useUpdateInsuranceMutation();
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      // console.log(res);
      navigate('/dashboard/reporting/seeinsurance');
    } catch (error) {
      console.error(error);
